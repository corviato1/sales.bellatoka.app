...
const SalesPage = () => {
  ...
  useEffect(() => {
    const handleEsc = (e) => {
      if (e.key === "Escape") setShowPesticideModal(false);
    };
    if (showPesticideModal) {
  ...
  return (
    <div className="sales-page">
      <header
        className={`site-header ${headerScrolled ? "site-header-scrolled" : "site-header-transparent"}`}
      >
        <a href="https://bellatoka.app" className="site-logo">
          Bella Toka
        </a>
      ...
      <section className="intro-component">
        <div
          ...
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/images/blackandwhite.jpg)`,
          }}
        ></div>
        <div className="intro-overlay">
          <div className="intro-content">
            ...
            <p className="intro-subtitle">
              Small-Batch Craft Flower for Discerning Distributors
            </p>
            <p className="intro-tagline">
              Secure your exclusive crop allocation of Bella Toka's P85 flower.
              Payment upon each fulfillment, perpetual access to data produced
              within contract period, and white-glove partnership support.
            </p>
        ...
        <div className="page-container">
          ...
          <div className="contract-highlights-row">
            ...
            <div className="contract-highlight-card">
              ...
              <p>
                Receive 100% of each harvest. Expected yield: ~6 lbs per week,
                pro-rated at set price per pound.
              </p>
            </div>
            <div className="contract-highlight-card">
              <div className="contract-highlight-icon">🔒</div>
              <h3>Exclusivity</h3>
              <p>
                Your allocation is guaranteed — no competing buyers on your
                contracted crop.
              </p>
            </div>
            <div className="contract-highlight-card">
              ...
              <p>
                Locked-in price per pound for the life of your contract. Payment
                is due at the time of each crop fulfillment.
              </p>
            </div>
            <div className="contract-highlight-card">
              <div className="contract-highlight-icon">📅</div>
              ...
              <p>
                Consistent harvest cycles with fulfillment at crop completion.
                Expected yield: ~6 lbs per week.
              </p>
            </div>
            <div className="contract-highlight-card">
              <div className="contract-highlight-icon">🔖</div>
              <h3>White Label</h3>
              <p>
                Default full white-label, or co-branded if desired. Your brand,
                your identity — we handle production.
              </p>
            </div>
            <div className="contract-highlight-card">
              <div className="contract-highlight-icon">🌿</div>
              ...
              <p>
                Complimentary terpene infusion from our Floraplex inventory.
                Choose from dozens of profiles or request your own.
              </p>
            </div>
            <div className="contract-highlight-card">
              ...
              <p>
                Full-featured dashboard with data analytics, image catalog, and
            ...
            <div className="contract-highlight-card">
              ...
              <p>
                White label is standard, but custom branding assistance is
          ...
          <div className="data-ownership-banner">
            ...
            <p>
              All cultivation data generated during your partnership is yours to
              leverage. After 3 years, you gain full ownership with the option
              to sell or license this data.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="page-container">
          ...
          <div className="facility-highlights-grid">
            ...
            <div className="facility-highlight-card">
              ...
              <p>
                Every plant is individually tended. Small batch sizes ensure
                consistent, premium-grade flower every harvest.
              </p>
            </div>
            <div className="facility-highlight-card">
              <div className="facility-highlight-icon">🔬</div>
              <h3>R&D Driven</h3>
              <p>
                Continuous strain development and optimization. Our facility
                doubles as a research environment for cultivation excellence.
              </p>
            </div>
            <div className="facility-highlight-card">
              <div className="facility-highlight-icon">📊</div>
              ...
              <p>
                Every data point from seed to sale is captured, stored, and
                accessible through your commercial dashboard.
              </p>
            </div>
          </div>
          ...
          <div className="facility-carousel-wrapper">
            ...
            <div className="image-carousel">
              <div
                ...
                style={{
                  transform: `translateX(-${plantCarouselIndex * 100}%)`,
                }}
              >
      ...
      <section id="product" className="product-section">
        <div className="page-container">
          ...
          <p className="section-description">
            Custom tailored craft cannabis flower, grown exclusively for your
            contract.
          </p>
            ...
            <div className="product-info-card">
              ...
              <div className="product-spec-list">
                ...
                <div className="product-spec-row">
                  ...
                  <span className="product-spec-value">
                    Indoor, hand-crafted small batch
                  </span>
                </div>
                <div className="product-spec-row">
      ...
      <section id="pest-management" className="pest-management-section">
        <div className="page-container">
          ...
          <p className="section-description">
            We use only approved, compliant pest management products for indoor
            cannabis cultivation. Full transparency on every product applied to
            your crop.
          </p>
          ...
          <div className="pest-products-grid">
            <div className="pest-product-card">
              ...
              <h3>Neem Oil</h3>
              <p>
                Natural broad-spectrum insecticide and fungicide derived from
            ...
            <div className="pest-product-card">
              ...
              <p>
                Plant-based biofungicide that activates the plant's natural
                defense mechanisms against powdery mildew and other fungal
                diseases.
              </p>
              <a
                href="https://profarmgroup.com/product/regalia-cg/"
                target="_blank"
                rel="noopener noreferrer"
                className="pest-product-link"
              >
            ...
            <div className="pest-product-card">
              ...
              <p>
                ...
                soft-bodied insects and mold. Safe to use up to the day of
                harvest.
              </p>
              <a
                href="https://www.doctorzymes.com/pesticide-free-insecticide.php"
                target="_blank"
                rel="noopener noreferrer"
                className="pest-product-link"
              >
            ...
            <div className="pest-product-card">
              ...
              <p>
                While we use only Regalia and Dr. Zymes as our standard protocol
                for indoor cannabis cultivation, we maintain a list of all
                approved pesticides for full transparency.
              </p>
              <button
                type="button"
                className="pest-product-link pest-product-link-button"
                onClick={() => setShowPesticideModal(true)}
              >
                View Full Legal Pesticides List →
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="page-container">
          ...
          <div className="terpene-overview-grid">
            ...
            <div className="terpene-overview-card">
              ...
              <h3>4-Day Process</h3>
              <p>
                Terpene infusion takes approximately 4 days (±1 day). Choose
                your profile during contract setup or change it between
                harvests.
              </p>
            </div>
          </div>
      ...
      <section id="dashboard" className="dashboard-section">
        <div className="page-container">
          ...
          <p className="section-description">
            Every contract includes a full-featured admin dashboard with data
            analytics, a custom frontend for your end users, and a complete
            image catalog.
          </p>
          ...
          <div className="dashboard-features-grid">
            <div className="dashboard-feature-card">
              ...
              <p>
                Full control over your account: manage orders, adjust
                quantities, schedule deliveries, and track every shipment.
              </p>
            </div>
            <div className="dashboard-feature-card">
            ...
            <div className="dashboard-feature-card">
              ...
              <p>
                High-resolution strain images, facility photos, and product
                photography — all accessible and downloadable from your
                dashboard.
              </p>
            </div>
          </div>
          ...
          <div className="dashboard-data-access-banner">
            <div className="data-access-content">
              ...
              <p>
                Your data never expires, decays, or gets lost. We maintain
                secure, accessible archives of all cultivation data for as long
                as you need it. No additional storage fees. Ever.
              </p>
            </div>
          </div>
      ...
      <section className="support-section">
        <div className="page-container">
          ...
          <p className="section-description">
            Every contract includes a dedicated account manager, priority
            communication, quarterly business reviews, and marketing support.
          </p>
      ...
      {showPesticideModal && (
        <div className="pdf-modal-overlay" onClick={() => setShowPesticideModal(false)}>
          <div className="pdf-modal" onClick={(e) => e.stopPropagation()}>
            <div className="pdf-modal-header">
              <h3>Approved Pesticides for Cannabis in California</h3>
              <button
                type="button"
                className="pdf-modal-close"
                onClick={() => setShowPesticideModal(false)}
              >
                ✕
              </button>
            </div>
