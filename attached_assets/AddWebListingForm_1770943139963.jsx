...
export default function AddWebListingForm({ listing, onSave, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h2 className="text-xl font-bold text-gray-900 mb-4">
        {listing ? 'Edit Listing' : 'Add Web Listing'}
      </h2>
      ...
      <Section title="Core Information" expanded={sections.core} onToggle={() => toggle('core')}>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="flex items-center gap-3 pt-6">
            <input
              type="checkbox"
              id="is_new_listing_web"
              checked={form.is_new_listing}
              onChange={(e) => set('is_new_listing', e.target.checked)}
              className="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500"
            />
            <label htmlFor="is_new_listing_web" className="text-sm font-medium text-gray-700">New Listing</label>
          </div>
        </div>
      </Section>
      ...
      <Section title="Property Details" expanded={sections.property} onToggle={() => toggle('property')}>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {renderSelect('Property Type', 'property_type', ['Residential'])}
      ...
      <Section title="Description" expanded={sections.description} onToggle={() => toggle('description')}>
